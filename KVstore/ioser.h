...
inline ifbinstream & operator<<(ifbinstream & m, ibinstream mm)
{
    m.raw_bytes(mm.get_buf(), mm.size());
    return m;
}

inline ifbinstream & operator<<(ifbinstream & m, size_t i)
{
    m.raw_bytes(&i, sizeof(size_t));
    return m;
}

inline ifbinstream & operator<<(ifbinstream & m, unsigned int i)
{
...
inline ifbinstream & operator<<(ifbinstream & m, bool i)
{
    m.raw_bytes(&i, sizeof(bool));
    return m;
}

inline ifbinstream & operator<<(ifbinstream & m, int i)
{
    m.raw_bytes(&i, sizeof(int));
    return m;
}

inline ifbinstream & operator<<(ifbinstream & m, long long i)
{
    m.raw_bytes(&i, sizeof(long long));
    return m;
}

inline ifbinstream & operator<<(ifbinstream & m, double i)
{
    m.raw_bytes(&i, sizeof(double));
    return m;
}

inline ifbinstream & operator<<(ifbinstream & m, char c)
{
    m.raw_byte(c);
    return m;
}
...
template <class T>
inline ifbinstream & operator<<(ifbinstream & m, const T* p)
{
    return m << *p;
}

template <class T>
inline ifbinstream & operator<<(ifbinstream & m, const vector<T>& v)
{
    m << v.size();
...
template <>
inline ifbinstream & operator<<(ifbinstream & m, const vector<int> & v)
{
    m << v.size();
...
template <>
inline ifbinstream & operator<<(ifbinstream & m, const vector<double> & v)
{
    m << v.size();
...
template <class T>
inline ifbinstream & operator<<(ifbinstream & m, const set<T> & v)
{
    m << v.size();
...
inline ifbinstream & operator<<(ifbinstream & m, const string & str)
{
    m << str.length();
...
inline ifbinstream & operator<<(ifbinstream & m, const map<KeyT, ValT> & v)
{
    m << v.size();
...
inline ofbinstream & operator>>(ofbinstream & m, size_t & i)
{
    i = *(size_t*)m.raw_bytes(sizeof(size_t));
    return m;
}

inline ofbinstream & operator>>(ofbinstream & m, unsigned int & i)
{
    i = *(unsigned int*)m.raw_bytes(sizeof(unsigned int));
    return m;
}

inline ofbinstream & operator>>(ofbinstream & m, bool & i)
{
    i = *(bool*)m.raw_bytes(sizeof(bool));
    return m;
}

inline ofbinstream & operator>>(ofbinstream & m, int & i)
{
    i = *(int*)m.raw_bytes(sizeof(int));
    return m;
}

inline ofbinstream & operator>>(ofbinstream & m, double & i)
{
    i = *(double*)m.raw_bytes(sizeof(double));
    return m;
}

inline ofbinstream & operator>>(ofbinstream & m, long long & i)
{
    i = *(long long*)m.raw_bytes(sizeof(long long));
    return m;
}

inline ofbinstream & operator>>(ofbinstream & m, char & c)
{
    c = m.raw_byte();
    return m;
}
...
template <class T>
inline ofbinstream & operator>>(ofbinstream & m, T* & p)
{
    p = new T;
    return m >> (*p);
}
...
template <class T>
inline ofbinstream & operator>>(ofbinstream & m, vector<T> & v)
{
    size_t size;
    m >> size;
    v.resize(size);
...
template <>
inline ofbinstream & operator>>(ofbinstream & m, vector<int> & v)
{
    size_t size;
    m >> size;
...
template <>
inline ofbinstream & operator>>(ofbinstream & m, vector<double> & v)
{
    size_t size;
    m >> size;
...
template <class T>
inline ofbinstream & operator>>(ofbinstream & m, set<T> & v)
{
    size_t size;
    m >> size;
...
inline ofbinstream & operator>>(ofbinstream & m, string & str)
{
    size_t length;
    m >> length;
    str.clear();
...
template <class KeyT, class ValT>
inline ofbinstream & operator>>(ofbinstream & m, map<KeyT, ValT> & v)
{
    size_t size;
    m >> size;
    for (size_t i = 0; i < size; i++) {
